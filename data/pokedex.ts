export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	rotom: {
		...
		color: "Red",
		eggGroups: ["Amorphous"],
		otherFormes: ["Rotom-Heat", "Rotom-Wash", "Rotom-Frost", "Rotom-Fan", "Rotom-Mow", "Rotom-Smog", "Rotom-Sound", "Rotom-Jack", "Rotom-Vision"],
		formeOrder: ["Rotom", "Rotom-Heat", "Rotom-Wash", "Rotom-Frost", "Rotom-Fan", "Rotom-Mow", "Rotom-Smog", "Rotom-Sound", "Rotom-Jack", "Rotom-Vision"],
	},
	rotomheat: {
		num: 479,
		name: "Rotom-Heat",
	...
	falinks: {
		...
		color: "Yellow",
		eggGroups: ["Fairy", "Mineral"],
		otherFormes: ["Falinks-Mega", "Falinks-Dawnian"],
		formeOrder: ["Falinks", "Falinks-Mega", "Falinks-Dawnian"],
	},
	falinksmega: {
		num: 870,
		name: "Falinks-Mega",
	...
	ameliven: {
		...
		name: "Ameliven",
		types: ["Water", "Psychic"],
		baseStats: { hp: 79, atk: 101, def: 61, spa: 110, spd: 79, spe: 100 },
		abilities: { 0: "Torrent", H: "Stakeout" },
		heightm: 15,
		weightkg: 398,
		color: "Blue",
		prevo: "Torchic dawnian",
		evoLevel: 1,
		eggGroups: ["Field"],
	},
	aveeon: {
		...
		name: "Aveeon",
		types: ["Flying"],
		baseStats: { hp: 65, atk: 110, def: 60, spa: 95, spd: 65, spe: 130 },
		abilities: { 0: "Cloud Nine", H: "Wind Rider" },
		heightm: 10,
		weightkg: 175,
		color: "White",
		prevo: "Eevee",
	...
	bogolotl: {
		...
		name: "Bogolotl",
		types: ["Grass"],
		baseStats: { hp: 100, atk: 130, def: 83, spa: 85, spd: 83, spe: 54 },
		abilities: { 0: "Overgrow", H: "No Guard" },
		heightm: 18,
		weightkg: 921,
		color: "Green",
		prevo: "Mudkip dawnian",
		evoLevel: 1,
		eggGroups: ["Monster", "Water 1"],
	},
	drimpact: {
		...
		types: ["Bug", "Dragon"],
		gender: "M",
		baseStats: { hp: 83, atk: 100, def: 72, spa: 45, spd: 100, spe: 85 },
		abilities: { 0: "Sturdy", H: "Technician" },
		heightm: 10,
		weightkg: 135,
		color: "Green",
		prevo: "Dwebble dawnian",
		evoLevel: 1,
		eggGroups: ["Bug", "Mineral"],
		otherFormes: ["Drimpact-F"],
		formeOrder: ["Drimpact", "Drimpact-F"],
	},
	drimpactf: {
		num: -103,
		name: "Drimpact-F",
		baseSpecies: "Drimpact",
		forme: "F",
		types: ["Bug", "Dragon"],
		gender: "F",
		baseStats: { hp: 83, atk: 100, def: 72, spa: 45, spd: 100, spe: 85 },
	...
	dripplin: {
		...
		name: "Dripplin",
		types: ["Water", "Dragon"],
		baseStats: { hp: 90, atk: 95, def: 110, spa: 80, spd: 70, spe: 40 },
		abilities: { 0: "Damp", 1: "Gluttony", H: "Sap Sipper" },
		heightm: 4,
		weightkg: 44,
		color: "Blue",
		prevo: "Applin",
	...
	ironexo: {
		...
		types: ["Dark", "Fighting"],
		gender: "N",
		baseStats: { hp: 85, atk: 125, def: 75, spa: 84, spd: 71, spe: 130 },
		abilities: { 0: "Quark Drive" },
		heightm: 20,
		weightkg: 2020,
		color: "Black",
	...
	ironjaws: {
		...
		gender: "N",
		baseStats: { hp: 103, atk: 67, def: 87, spa: 130, spd: 87, spe: 96 },
		abilities: { 0: "Quark Drive", H: "Quark Drive" },
		heightm: 6,
		weightkg: 202,
		color: "Pink",
		eggGroups: ["Undiscovered"],
	...
	lameyser: {
		...
		name: "Lameyser",
		types: ["Fire", "Water"],
		baseStats: { hp: 81, atk: 79, def: 70, spa: 118, spd: 102, spe: 70 },
		abilities: { 0: "White Smoke", 1: "Water Absorb", H: "Regenerator" },
		heightm: 8,
		weightkg: 721,
		color: "Red",
		prevo: "Camerupt dawnian",
		evoLevel: 1,
		eggGroups: ["Field"],
	},
	lindcider: {
		...
		name: "Lindcider",
		types: ["Poison", "Dragon"],
		baseStats: { hp: 110, atk: 115, def: 95, spa: 80, spd: 80, spe: 60 },
		abilities: { 0: "Damp", 1: "Gluttony", H: "Contrary" },
		heightm: 18,
		weightkg: 110,
		color: "Purple",
		prevo: "Dripplin",
	...
	luderigus: {
		...
		name: "Luderigus",
		types: ["Ghost", "Dark"],
		baseStats: { hp: 79, atk: 100, def: 95, spa: 90, spd: 96, spe: 25 },
		abilities: { 0: "Super Luck", H: "Super Luck" },
		heightm: 17,
		weightkg: 765,
		color: "Purple",
		prevo: "Yamask dawnian",
		evoLevel: 1,
		eggGroups: ["Mineral", "Amorphous"],
	},
	lumberingdunce: {
		num: -110,
		name: "Lumbering Dunce",
		types: ["Water", "Poison"],
		gender: "N",
		baseStats: { hp: 121, atk: 80, def: 128, spa: 60, spd: 128, spe: 53 },
		abilities: { 0: "Protosynthesis" },
		heightm: 82,
		weightkg: 3360,
		color: "Blue",
	...
	perakkii: {
		...
		name: "Perakkii",
		types: ["Psychic"],
		baseStats: { hp: 55, atk: 77, def: 77, spa: 77, spd: 77, spe: 77 },
		abilities: {
		0: "Pickup",
		1: "Magician",
		H: "Super Luck",
	...
	queentana: {
		...
		name: "Queentana",
		types: ["Fairy", "Steel"],
		baseStats: { hp: 75, atk: 112, def: 70, spa: 78, spd: 75, spe: 95 },
		abilities: { 0: "Queenly Majesty", 1: "Inner Focus", H: "Sharpness" },
		heightm: 3,
		weightkg: 234,
		color: "Pink",
		prevo: "Pawniard",
	...
	scameleon: {
		...
		name: "Scameleon",
		types: ["Normal", "Ghost"],
		baseStats: { hp: 78, atk: 115, def: 80, spa: 58, spd: 95, spe: 105 },
		abilities: { 0: "Color Change", H: "Protean" },
		heightm: 10,
		weightkg: 220,
		color: "Brown",
	...
	varunalas: {
		...
		name: "Varunalas",
		types: ["Fire", "Ground"],
		baseStats: { hp: 95, atk: 118, def: 90, spa: 55, spd: 87, spe: 85 },
		abilities: { 0: "Blaze", H: "Intimidate" },
		heightm: 15,
		weightkg: 568,
		color: "Red",
		prevo: "Treecko dawnian",
		evoLevel: 1,
		eggGroups: ["Monster", "Dragon"],
	},
	wendiglim: {
		...
		name: "Wendiglim",
		types: ["Ghost", "Rock"],
		baseStats: { hp: 105, atk: 124, def: 106, spa: 57, spd: 68, spe: 45 },
		abilities: { 0: "Keen Eye", 1: "Tough Claws", H: "Rock Head" },
		heightm: 4,
		weightkg: 355,
		color: "Purple",
		prevo: "Sableye dawnian",
		evoLevel: 1,
		eggGroups: ["Human-Like"],
	},
	cameruptdawnian: {
		num: -5015,
		name: "Camerupt-Dawnian",
		baseSpecies: "Camerupt",
		forme: "Dawnian",
		types: ["Fire", "Water"],
		baseStats: { hp: 80, atk: 90, def: 65, spa: 105, spd: 75, spe: 45 },
		abilities: {
		0: "White Smoke",
		1: "Water Absorb",
		H: "Healer",
	...
	dwebbledawnian: {
		num: -5016,
		name: "Dwebble-Dawnian",
		baseSpecies: "Dwebble",
		forme: "Dawnian",
		types: ["Bug", "Water"],
		baseStats: { hp: 50, atk: 85, def: 35, spa: 35, spd: 65, spe: 55 },
		abilities: {
		0: "Sturdy",
		1: "Iron Fist",
		H: "Technician",
	...
	falinksdawnian: {
		num: -5017,
		name: "Falinks-Dawnian",
		baseSpecies: "Falinks",
		forme: "Dawnian",
		types: ["Fighting", "Fairy"],
		gender: "N",
		baseStats: { hp: 65, atk: 60, def: 115, spa: 60, spd: 115, spe: 55 },
		abilities: {
		0: "Formation",
		H: "Formation",
	},
	...
	falinksdawnianoffensive: {
		num: -5018,
		name: "Falinks-Dawnian-Offensive",
		baseSpecies: "Falinks",
		forme: "Dawnian-Offensive",
		types: ["Fighting", "Fairy"],
		gender: "N",
		baseStats: { hp: 65, atk: 105, def: 50, spa: 105, spd: 50, spe: 95 },
		abilities: {
		0: "Formation",
		H: "Formation",
	},
		...
		color: "Red",
		eggGroups: ["Undiscovered"],
		requiredAbility: "Formation",
		battleOnly: "Falinks-Dawnian",
	},
	glimmetdawnian: {
		num: -5019,
		name: "Glimmet-Dawnian",
		baseSpecies: "Glimmet",
		forme: "Dawnian",
		types: ["Poison", "Flying"],
		baseStats: { hp: 48, atk: 75, def: 42, spa: 55, spd: 40, spe: 90 },
		abilities: {
		0: "Tinted Lens",
		H: "Corrosion",
	},
	...
	glimmoradawnian: {
		...
		forme: "Dawnian",
		types: ["Poison", "Flying"],
		baseStats: { hp: 75, atk: 110, def: 65, spa: 75, spd: 95, spe: 105 },
		abilities: {
		0: "Tinted Lens",
		H: "Corrosion",
	},
	...
	heracrossdawnian: {
		num: -5021,
		name: "Heracross-Dawnian",
		baseSpecies: "Heracross",
		forme: "Dawnian",
		types: ["Bug", "Ground"],
		baseStats: { hp: 95, atk: 100, def: 114, spa: 59, spd: 70, spe: 62 },
		abilities: {
		0: "Shell Armor",
		1: "Shield Dust",
		H: "Earth Eater",
	...
	laprasmega: {
		...
		forme: "Mega",
		types: ["Ice", "Water"],
		baseStats: { hp: 130, atk: 95, def: 90, spa: 120, spd: 115, spe: 85 },
		abilities: {
		0: "Liquid Voice",
		H: "Liquid Voice",
	},
	...
	lilligantdawnian: {
		num: -5023,
		name: "Lilligant-Dawnian",
		baseSpecies: "Lilligant",
		forme: "Dawnian",
		types: ["Grass", "Fire"],
		baseStats: { hp: 70, atk: 100, def: 65, spa: 90, spd: 40, spe: 105 },
		abilities: {
		0: "Weak Armor",
		1: "Dancer",
		H: "Sharpness",
	...
	luxraydawnian: {
		...
		forme: "Dawnian",
		types: ["Electric", "Ice"],
		baseStats: { hp: 75, atk: 105, def: 79, spa: 65, spd: 79, spe: 120 },
		abilities: {
		0: "Rivalry",
		1: "Fur Coat",
		H: "Strong Jaw",
	...
	mudkipdawnian: {
		...
		baseStats: { hp: 60, atk: 75, def: 50, spa: 40, spd: 50, spe: 35 },
		abilities: {
		0: "Overgrow",
		H: "No Guard",
	},
	...
	musharnamega: {
		...
		forme: "Mega",
		types: ["Psychic"],
		baseStats: { hp: 116, atk: 75, def: 105, spa: 127, spd: 115, spe: 49 },
		abilities: {
		0: "Magic Guard",
		H: "Magic Guard",
	},
	...
	numeldawnian: {
		...
		forme: "Dawnian",
		types: ["Fire", "Water"],
		baseStats: { hp: 70, atk: 40, def: 45, spa: 75, spd: 50, spe: 35 },
		abilities: {
		0: "White Smoke",
		1: "Water Absorb",
		H: "Healer",
	...
	sableyedawnian: {
		num: -5028,
		name: "Sableye-Dawnian",
		baseSpecies: "Sableye",
		forme: "Dawnian",
		types: ["Ghost", "Rock"],
		baseStats: { hp: 50, atk: 95, def: 55, spa: 40, spd: 40, spe: 90 },
		abilities: {
		0: "Keen Eye",
		1: "Dazzling",
		H: "Rock Head",
	...
	treeckodawnian: {
		...
		baseStats: { hp: 50, atk: 65, def: 45, spa: 50, spd: 50, spe: 50 },
		abilities: {
		0: "Blaze",
		H: "Flame Body",
	},
	...
	yamaskdawnian: {
		...
		forme: "Dawnian",
		types: ["Ghost"],
		baseStats: { hp: 38, atk: 65, def: 45, spa: 30, spd: 65, spe: 30 },
		abilities: {
		0: "Defeatist",
		H: "Defeatist",
	},
	...
	glimmoradawnianmega: {
		...
		forme: "Mega",
		types: ["Poison", "Flying"],
		baseStats: { hp: 75, atk: 142, def: 85, spa: 88, spd: 112, spe: 123 },
		abilities: {
		0: "Wind Rider",
	},
		heightm: 1.5,
